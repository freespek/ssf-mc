...
Gasper~\cite{buterin2020combining}, Ethereum’s current consensus protocol, typically requires 64 to 95 slots – the units of time 
during which a new chain extending the previous one by one block is proposed and voted – to finalize. 

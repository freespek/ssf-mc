...
\paragraph{Insight.} Translation rules from other artifacts can provide useful starting
points for specifications, but are also likely to introduce unwanted
inefficiencies. Automated tools cannot account for the nuances of the specific

...
\newcommand{\SpecOne}{$\textit{Spec}_1$}
\newcommand{\SpecTwo}{$\textit{Spec}_2$}
\newcommand{\SpecThree}{$\textit{Spec}_3$}
\newcommand{\SpecThreeB}{$\textit{Spec}_{3b}$}
\newcommand{\SpecThreeC}{$\textit{Spec}_{3c}$}
\newcommand{\SpecFour}{$\textit{Spec}_4$}
\newcommand{\SpecFourB}{$\textit{Spec}_{4b}$}
\lstset{%
...
% the style for pretty-printed Python code
...
\tikzset{>=latex}
\tikzset{a/.style={-{Latex[length=2mm,width=1.5mm]}}}
